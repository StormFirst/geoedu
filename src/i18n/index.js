  ...
  ru: {
    translation: {
      ...
      nav: {
        ...
        dashboard: 'Панель',
        groupMain: 'Главное',
        groupLearning: 'Обучение',
        groupGis: 'ГИС и Карты',
        groupEvaluation: 'Оценка и Результаты',
        groupCommunity: 'Рейтинг и Игры',
        subjects: 'Предметы',
        mapTools: 'Интерактивная карта',
        aiAssistant: 'AI Ассистент',
        gisLab: 'ГИС Лаборатория',
        gisCaseStudy: 'ГИС Case Study',
        arcgis3d: 'ArcGIS 3D Карта',
        gamification: 'Геоигра',
        videos: 'Видеоуроки',
        tests: 'Тесты',
        assignments: 'Задания',
        materials: 'Материалы',
  ...
  en: {
    translation: {
      ...
      nav: {
        ...
        dashboard: 'Dashboard',
        groupMain: 'Main',
        groupLearning: 'Learning Center',
        groupGis: 'GIS & Mapping',
        groupEvaluation: 'Evaluation & Badges',
        groupCommunity: 'Rank & Games',
        subjects: 'Subjects',
        mapTools: 'Interactive Map',
        aiAssistant: 'AI Assistant',
        gisLab: 'GIS Laboratory',
        gisCaseStudy: 'GIS Case Study',
        arcgis3d: 'ArcGIS 3D Map',
        gamification: 'GeoGame',
